export const bnIN = {
  ...
  exam: {
    title: "Exam",
    promptLabel: "Exam request",
    promptPlaceholder: "Describe the exam you want (topic, difficulty, number of questions, format)...",
    promptRequired: "Please enter an exam request prompt",
    generate: "Generate Exam",
    generated: "Exam generated",
    generateFailed: "Failed to generate exam",
    generatedExam: "Generated exam",
    examPlaceholder: "Generated exam content will appear here...",
    submissionLabel: "Your answers",
    submissionPlaceholder: "Write your answers for each question here...",
    missingForGrading: "Prompt, exam, and answers are required for grading",
    grade: "Submit & Grade",
    graded: "Grading completed",
    gradeFailed: "Failed to grade submission",
